        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${lstProduct}" var="o">
                <tr>
                    ...
                    <td>${o.quantity} $</td>
                    <td>
                        <a href="editProduct?id=${o.ma }" class="edit" data-toggle="modal"><i class="material-icons"
                                                                                              data-toggle="tooltip"
                                                                                              title="Edit">&#xE254;</i></a>
                        <a href="deleteProduct?id=${o.ma }" class="delete" data-toggle="modal"><i class="material-icons"
                                                                                                  data-toggle="tooltip"
                                                                                                  title="Delete">&#xE872;</i></a>
                    </td>
                </tr>
