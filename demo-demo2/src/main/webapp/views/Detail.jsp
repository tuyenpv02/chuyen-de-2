						...
						<div class="row">
							<aside class="col-sm-5 border-right">
								<article class="gallery-wrap">
									<div class="img-big-wrap"> img
										<div>
											<a href="#"><img src="${productDetail.image}"></a>
										</div>
									</div>
									<!-- slider-product.// -->
								...
								<article class="card-body p-5">
									...
									<p class="price-detail-wrap">
										<span class="price h3 text-warning"> <span
											class="currency"> $ </span><span class="num"> ${productDetail.price} </span>
										</span>
										<!--<span>/per kg</span>-->
									</p>
									<!-- price-detail-wrap .// -->
									...
									<div class="row">
										<div class="col-sm-5">
											<dl class="param param-inline">
												<dt>Quantity: ${productDetail.quantity}</dt>
											</dl>
											<!-- item-property .// -->
										</div>
										<!-- col.// -->
